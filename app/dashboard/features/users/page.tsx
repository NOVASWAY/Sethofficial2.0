...
interface SystemUser {
  ...
  email: string
  phone: string
  role: 'admin' | 'clinician' | 'nurse' | 'pharmacist' | 'lab_technician' | 'receptionist'
...
export default function UsersPage() {
  ...
  const addUser = async (userData: any): Promise<SystemUser> => {
  ...
  const updateUser = async (id: string, updateData: any): Promise<void> => {
  ...
  const updateUserPermissions = async (id: string, permissions: string[]): Promise<void> => {
