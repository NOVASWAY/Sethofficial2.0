...
export default function PrescriptionsPage() {
  ...
  const canCreatePrescriptions = role === "clinician" || role === "admin" || role === "doctor"
  const canViewPrescriptions = role === "clinician" || role === "pharmacist" || role === "admin" || role === "nurse" || role === "doctor"
