...
// Professional toast variants with icons
...
>(({ className, variant = "default", icon, title, description, ...props }, ref) => {
  const getIcon = () => {
    if (icon) return icon
  ...
  return (
    <Toast ref={ref} variant={variant} className={cn("min-w-[300px]", className)} {...props}>
